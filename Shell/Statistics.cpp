...
#define SEPARATOR if (separable) { addCommentSignForSZS(out); out << endl; separable = false; }
  ...
  COND_OUT("ForwardDownwardParamodulation", forwardDownwardParamodulation);
  ...
  COND_OUT("InductionEqResolution", inductionEqResolution);
